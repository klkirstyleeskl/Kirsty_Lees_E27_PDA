...
describe('calculator functionality', function() {
  ...
  it('should have expected outputs when handling decimals', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number5')).click()
    element(by.css('#operator_divide')).click()
    element(by.css('#number2')).click();
  ...
  it('should have expected outputs when handling negative numbers', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number5')).click()
    element(by.css('#operator_subtract')).click()
  ...
  it('should have expected outputs when handling large numbers', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number5')).click()
    element(by.css('#number5')).click()
    element(by.css('#number5')).click()
    ...
    element(by.css('#number7')).click();
    element(by.css('#operator_equals')).click();
    expect(running_total.getAttribute('value')).to.eventually.equal('38888885')
  })

  it('should return NaN in certain functions', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number5')).click()
    element(by.css('#operator_divide')).click()
